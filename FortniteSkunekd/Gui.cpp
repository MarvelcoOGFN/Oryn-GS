#include "framework.h" // required for bools + sdk
...
// ill clean this up in the future
LPDIRECT3D9              Gui::g_pD3D = nullptr;
LPDIRECT3DDEVICE9        Gui::g_pd3dDevice = nullptr;
UINT                     Gui::g_ResizeWidth = 0, Gui::g_ResizeHeight = 0;
D3DPRESENT_PARAMETERS    Gui::g_d3dpp = {};

// skidded from luna 1.11 gs!
void Gui::InitImGui() {
    ImGui::CreateContext();
...
DWORD WINAPI Gui::ImGuiThread(LPVOID) {
    WNDCLASSEXW wc = { sizeof(wc), CS_CLASSDC, WndProc, 0L, 0L, GetModuleHandle(nullptr), nullptr, nullptr, nullptr, nullptr, L"Oryn", nullptr };
    ::RegisterClassExW(&wc);
    HWND hwnd = ::CreateWindowW(wc.lpszClassName, L"Oryn", WS_OVERLAPPEDWINDOW, 100, 100, 700, 700, nullptr, nullptr, wc.hInstance, nullptr);
    ...
    while (!done)
    {
       ...
       /* RECT rect;
        ...
        // i havent tested this! ui might look off
